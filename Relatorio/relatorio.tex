...
ela pode começar pelas funções \emph{p\_program\_1}, \emph{p\_func\_list} ou
produções vazias. Note que optamos por utilizar a regra inicial \emph{program}. 
...
está presente tanto no First quanto no Follow. Sendo assim, a nossa gramática está em
